...
define('echarts/util/graphic', ['require', 'zrender/core/util', 'zrender/tool/path', 'zrender/graphic/Path', 'zrender/tool/color', 'zrender/core/matrix', 'zrender/core/vector', 'zrender/mixin/Transformable', 'zrender/core/BoundingRect', 'zrender/container/Group', 'zrender/graphic/Image', 'zrender/graphic/Text', 'zrender/graphic/shape/Circle', 'zrender/graphic/shape/Sector', 'zrender/graphic/shape/Ring', 'zrender/graphic/shape/Polygon', 'zrender/graphic/shape/Polyline', 'zrender/graphic/shape/Rect', 'zrender/graphic/shape/Line', 'zrender/graphic/shape/BezierCurve', 'zrender/graphic/shape/Arc', 'zrender/graphic/CompoundPath', 'zrender/graphic/LinearGradient', 'zrender/graphic/RadialGradient'], function (require) {
     ...
     */
    graphic.setLabelStyle = function (normalStyle, emphasisStyle, normalModel, emphasisModel, opt, normalSpecified, emphasisSpecified) {
        opt = opt || EMPTY_OBJ;
        ...
        var emphasisStyleText = showEmphasis ? zrUtil.retrieve2(labelFetcher ? labelFetcher.getFormattedLabel(labelDataIndex, 'emphasis', null, labelDimIndex) : null, baseText) : null;
     ...
     */
    var setTextStyle = graphic.setTextStyle = function (textStyle, textStyleModel, specifiedTextStyle, opt, isEmphasis) {
    ...
    function setTokenTextStyle(textStyle, textStyleModel, globalTextStyle, opt, isEmphasis, isBlock) {
        ...
        textStyle.textLineWidth = zrUtil.retrieve2(textStyleModel.getShallow('textBorderWidth'), globalTextStyle.textBorderWidth);
        if (!isEmphasis) {
            if (isBlock) {
    ...
    graphic.createIcon = function (iconStr, opt, rect) {
        ...
        if (iconStr) {
            return iconStr.indexOf('image://') === 0 ? (style.image = iconStr.slice(8), zrUtil.defaults(style, rect), new graphic.Image(opt)) : graphic.makePath(iconStr.replace('path://', ''), opt, rect, 'center');
        }
    };
    return graphic;
});
        ...
        getLabelInterval: function () {
            ...
            if (!labelInterval) {
                ...
                if (!(this.type === 'category' && interval === 'auto')) {
                    ...
                    labelInterval = axisHelper.getAxisLabelInterval(zrUtil.map(this.scale.getTicks(), this.dataToCoord, this), axisModel.getFormattedLabels(), labelModel.getFont(), this.isHorizontal());
                }
    ...
    function parseRichText(text, style) {
        ...
        for (var i = 0; i < lines.length; i++) {
            ...
            for (var j = 0; j < line.tokens.length; j++) {
                ...
                var tokenHeight = token.textHeight = retrieve2(tokenStyle.textHeight, textContain.getLineHeight(font));
...
define('echarts/preprocessor/helper/compatStyle', ['require', 'zrender/core/util', '../../util/model'], function (require) {
    var zrUtil = require('zrender/core/util');
    var modelUtil = require('../../util/model');
    var each = zrUtil.each;
    var isObject = zrUtil.isObject;
...
define('echarts/chart/bar/helper', ['require', '../../util/graphic'], function (require) {
    var graphic = require('../../util/graphic');
    var helper = {};

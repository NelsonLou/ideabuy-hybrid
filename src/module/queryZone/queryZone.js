...
import queryZone from './queryZone.vue'
import queryZoneRouter from './router'
import Router from 'vue-router'
import {AlertPlugin, DatetimePlugin} from 'vux'
...
const router = new Router(queryZoneRouter)

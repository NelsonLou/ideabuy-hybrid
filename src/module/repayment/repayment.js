...
import repaymentRouter from './router'
...
const router = new Router(repaymentRouter)
document.body.addEventListener('touchstart', () => {
  // document.querySelector('.my-fixed').removeAttribute('style')
})
